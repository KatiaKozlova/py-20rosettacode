...
:arrow_up: **больше всего** переменных на токен в *BASIC*, но, скорее всего просто _выброс_;<br/>
:arrow_up: **больше среднего** только у _BASIC и C_, все остальные примерно **на одном уровне**<br/>
...
:arrow_up: в _BASIC_ их **больше всего**, так как в нем названия типов переменных и другие "служебные слова" пишутся также с большой буквы (возможно, выброс);<br/>
:arrow_down: **меньше всего** заглавных букв _Python и Icon/Unicon_<br/>
<br/><br/><br/><br/><br/>
...
:arrow_up: в _C++ и C_ **больше всего** dash-ей;<br/>
:arrow_down: в _С#_ же их **мало** (возможно, из-за того, что он _более прикладной_);<br/>
...
:exclamation: в группе _С++, С, С#_:<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; _С#_ отличается по числу **dash-ей и больших букв**<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; _С_ отличается по **средним длинам**<br/>
<br/>
